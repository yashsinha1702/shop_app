              ...
              itemBuilder: (context,index) {
                ...
                return Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Chip(side: BorderSide(
                          color: Color.fromRGBO(245, 246, 249, 1)),
                        shape : StadiumBorder(),
                        backgroundColor: selectedFilter == filter ? Theme.of(context).colorScheme.primary:Color.fromRGBO(245, 246, 249, 1),
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context,index) {
                  ...
                  return GestureDetector(
                    ...
                    child: ProductCard(title: product['title'] as String,price: product['price'] as double,
